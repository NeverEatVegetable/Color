System.register(["__unresolved_0", "cc", "chai", "__unresolved_1"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      describe("基础方法", () => {
        test('delay', /*#__PURE__*/_asyncToGenerator(function* () {
        ...
        test('groupByArr', /*#__PURE__*/_asyncToGenerator(function* () {
          var _r$get, _r$get2, _r$get3, _r$get4;

          var r = (_crd && arrGroup === void 0 ? (_reportPossibleCrUseOfarrGroup({
            error: Error()
          }), arrGroup) : arrGroup)([{
            key: '1',
            name: 'a'
        ...
        test('arrSkipAndLimit', /*#__PURE__*/_asyncToGenerator(function* () {
          var r = (_crd && arrSkipAndLimit === void 0 ? (_reportPossibleCrUseOfarrSkipAndLimit({
            error: Error()
