System.register(["__unresolved_0", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfreq(extras) {
    _reporterNs.report("req", "./postBuild.js", _context.meta, extras);
  }

  function _reportPossibleCrUseOfd(extras) {
    _reporterNs.report("d", "./postBuild.js", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      _crd = true; // I am the facade module who provides access to the CommonJS module './postBuild.js'~

      if (!(_crd && req === void 0 ? (_reportPossibleCrUseOfreq({
        error: Error()
      }), req) : req)) {
        loader.throwInvalidWrapper('./postBuild.js', _context.meta.url);
      }
...
//# sourceMappingURL=a15ad0f2f703bfd590b2d9bdb39e9e4d033b3960.js.map