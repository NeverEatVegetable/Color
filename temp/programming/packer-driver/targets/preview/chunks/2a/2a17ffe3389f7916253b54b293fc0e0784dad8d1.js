System.register(["__unresolved_0", "cc", "path", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  function startWatchServerConfig() {
    return _startWatchServerConfig.apply(this, arguments);
  }
  /**获取gf.clusterServer.config.json配置，配置文件有变化会自动读取最新的*/


  function _startWatchServerConfig() {
    _startWatchServerConfig = _asyncToGenerator(function* () {
      var getAndInitConfig = /*#__PURE__*/function () {
        var _ref2 = _asyncToGenerator(function* () {
          var cfg = yield getServerConfig();
        ...
        return function getAndInitConfig() {
          return _ref2.apply(this, arguments);
        };
      }();

      var ret = yield (_crd && startWatchConfig === void 0 ? (_reportPossibleCrUseOfstartWatchConfig({
        error: Error()
      ...
      var getConfig = ret.data;
      return yield getAndInitConfig();
    });
    return _startWatchServerConfig.apply(this, arguments);
  }
  ...
  function _getServerConfig() {
    _getServerConfig = _asyncToGenerator(function* () {
      //如果有指定内存配置，则直接返回
      if (memServerConfig) return memServerConfig; //尝试加载文件配置

      var ret = yield (_crd && getConfigAuto === void 0 ? (_reportPossibleCrUseOfgetConfigAuto({
        error: Error()
  ...
  function getServerRedisClient(_x) {
    return _getServerRedisClient.apply(this, arguments);
  }

  function _getServerRedisClient() {
    _getServerRedisClient = _asyncToGenerator(function* (reuseClient) {
      if (reuseClient === void 0) {
        reuseClient = true;
      }

      return yield (_crd && getRedisClient === void 0 ? (_reportPossibleCrUseOfgetRedisClient({
        error: Error()
