      ...
      _export("GameClusterNodeClient", GameClusterNodeClient = class GameClusterNodeClient extends (_crd && ClusterNodeClient === void 0 ? (_reportPossibleCrUseOfClusterNodeClient({
        ...
        constructor(gameServerCfg, getGameServerCfg, getServerClientCount) {
          super(_crd && gameClusterServiceProto === void 0 ? (_reportPossibleCrUseOfgameClusterServiceProto({
            ...
            error: Error()
          }), EClusterClientType) : EClusterClientType).Node, gameServerCfg.clusterNodeId, gameServerCfg.clusterKey, /*#__PURE__*/_asyncToGenerator(function* () {
            var cfg = yield getGameServerCfg();
            var serverInfo = {
        ...
        extractRoom(roomId) {
          ...
          return _asyncToGenerator(function* () {
            if (!_this.nodeClient) return (_crd && Result === void 0 ? (_reportPossibleCrUseOfResult({
              error: Error()
            ...
            var ret = yield _this.nodeClient.callApi('NodeExtractRoom', {
              roomId
            });
        ...
        updateRoom(roomRegInfo, changedType, playerId, teamId, oldTeamId) {
          var _this2 = this;

          return _asyncToGenerator(function* () {
            if (!_this2.nodeClient) return (_crd && Result === void 0 ? (_reportPossibleCrUseOfResult({
              error: Error()
            }), Result) : Result).buildErr('当前服务器断开！请稍后再试！', (_crd && ErrorCodes === void 0 ? (_reportPossibleCrUseOfErrorCodes({
              error: Error()
            }), ErrorCodes) : ErrorCodes).AuthUnverified);
            var ret = yield _this2.nodeClient.callApi('NodeUpdateRoom', {
              roomRegInfo,
              changedType,
              playerId,
              teamId,
        ...
        dismissRoom(roomId) {
          ...
          return _asyncToGenerator(function* () {
            if (!_this3.nodeClient) return (_crd && Result === void 0 ? (_reportPossibleCrUseOfResult({
              error: Error()
            }), Result) : Result).buildErr('当前服务器断开！请稍后再试！', (_crd && ErrorCodes === void 0 ? (_reportPossibleCrUseOfErrorCodes({
              error: Error()
            }), ErrorCodes) : ErrorCodes).AuthUnverified);
            var ret = yield _this3.nodeClient.callApi('NodeDismissRoom', {
              roomId
            });
