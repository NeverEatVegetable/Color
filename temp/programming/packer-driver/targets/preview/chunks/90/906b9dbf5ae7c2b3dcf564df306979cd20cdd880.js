System.register(["__unresolved_0", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfreq(extras) {
    _reporterNs.report("req", "./copyright.js", _context.meta, extras);
  }

  function _reportPossibleCrUseOfd(extras) {
    _reporterNs.report("d", "./copyright.js", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      _crd = true; // I am the facade module who provides access to the CommonJS module './copyright.js'~

      if (!(_crd && req === void 0 ? (_reportPossibleCrUseOfreq({
        error: Error()
      }), req) : req)) {
        loader.throwInvalidWrapper('./copyright.js', _context.meta.url);
      }
...
//# sourceMappingURL=906b9dbf5ae7c2b3dcf564df306979cd20cdd880.js.map