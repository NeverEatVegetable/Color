System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "42e64UaMXZAUpLZXg2gikfb", "HallClient", undefined);
      ...
      _export("HallClient", HallClient = class HallClient extends (_crd && AHttpClient === void 0 ? (_reportPossibleCrUseOfAHttpClient({
        ...
        recoverPlayerRoom(playerId, playerToken, updateShowName) {
          var _this = this;

          return _asyncToGenerator(function* () {
            var ret = yield _this.client.callApi("RecoverPlayerRoom", {
              playerId: playerId,
        ...
        createRoom(playerToken, createPa) {
          var _this2 = this;

          return _asyncToGenerator(function* () {
            var para = createPa;
            para.playerToken = playerToken;
            var ret = yield _this2.client.callApi("CreateRoom", para);
        ...
        getRoomOnlineInfo(playerToken, roomId) {
          var _this3 = this;

          return _asyncToGenerator(function* () {
            var ret = yield _this3.client.callApi("GetRoomOnlineInfo", {
              playerToken: playerToken,
              roomId: roomId
            });
        ...
        getOrCreateRoom(playerToken, para) {
          var _this4 = this;

          return _asyncToGenerator(function* () {
            var ret = yield _this4.client.callApi("GetOrCreateRoom", _extends({}, para, {
              playerToken
            }));
        ...
        requestMatch(playerToken, matchParams) {
          var _this5 = this;

          return _asyncToGenerator(function* () {
            var ret = yield _this5.client.callApi("RequestMatch", {
              playerToken: playerToken,
        ...
        queryMatch(playerToken, matchReqId) {
          var _this6 = this;

          return _asyncToGenerator(function* () {
            var ret = yield _this6.client.callApi("QueryMatch", {
              playerToken: playerToken,
        ...
        cancelMatch(playerToken, matchReqId) {
          var _this7 = this;

          return _asyncToGenerator(function* () {
            var ret = yield _this7.client.callApi("CancelMatch", {
              playerToken: playerToken,
              matchReqId: matchReqId
            });
        ...
        filterRooms(playerToken, filter, skip, limit) {
          var _this8 = this;

          return _asyncToGenerator(function* () {
            var ret = yield _this8.client.callApi("FilterRooms", {
              playerToken,
              filter,
              skip,
              limit
        ...
        ownDismissRoom(playerToken, roomId) {
          var _this9 = this;

          return _asyncToGenerator(function* () {
            var ret = yield _this9.client.callApi("OwnDismissRoom", {
              playerToken: playerToken,
              roomId: roomId
            });
...
//# sourceMappingURL=8d897dcddc5a32512e48c6e09c1677aadd798b10.js.map