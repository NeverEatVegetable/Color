  ...
  return {
    ...
    execute: function () {
      ...
      _cjsLoader.define(__cjsMetaURL, function (exports, require, module, __filename, __dirname) {
        ...
        var path = require('path'); // remove private / protected index.d.ts


        (() => {
          var content = fs.readFileSync(path.resolve(__dirname, '../dist/index.d.ts'), 'utf-8');
...
//# sourceMappingURL=20e27b4946c5fd638cf409cf659bd7e095338641.js.map