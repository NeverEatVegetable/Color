      ...
      _export("AppCrypto", AppCrypto = class AppCrypto {
        ...
        decryptionReq(req) {
          return _asyncToGenerator(function* () {
            ...
            var appRet = yield (_crd && SimpleAppHelper === void 0 ? (_reportPossibleCrUseOfSimpleAppHelper({
              error: Error()
            ...
            var ret = (_crd && ApiCryptoHelper === void 0 ? (_reportPossibleCrUseOfApiCryptoHelper({
              error: Error()
