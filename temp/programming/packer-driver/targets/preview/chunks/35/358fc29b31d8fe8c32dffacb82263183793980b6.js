      ...
      */
      ...
      _export("RoomHelper", RoomHelper = class RoomHelper {
        ...
        static buildRoomInfo(appId, gameServerInfo, para) {
          ...
          var roomId = para.roomId || (_crd && buildGuid === void 0 ? (_reportPossibleCrUseOfbuildGuid({
            error: Error()
          ...
          if (para.fixedTeamInfoList && para.fixedTeamInfoList.length) {
            ...
            for (var i = 0; i < para.fixedTeamCount; i++) {
        ...
        static startListenRoomRegInfoChanged(listen) {
          var _this = this;

          return _asyncToGenerator(function* () {
            var subscribeClient = yield _this.getRedisClient(false);
            yield subscribeClient.subscribeObject("RoomRegInfoChanged", listen);
            return {
              cancel() {
                return _asyncToGenerator(function* () {
                  yield subscribeClient.disconnect();
                })();
              }
        ...
        static getRoomEmptySeats(roomInfo) {
          var v = roomInfo.maxPlayers - roomInfo.playerList.length;
