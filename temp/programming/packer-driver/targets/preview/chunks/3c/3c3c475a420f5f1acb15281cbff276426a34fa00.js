  ...
  return {
    ...
    execute: function () {
      ...
      describe("服务器分配规则验证", () => {
        ...
        test('单类型房间数限制', /*#__PURE__*/_asyncToGenerator(function* () {
        ...
        test('类型加最大玩家数10的房间数限制', /*#__PURE__*/_asyncToGenerator(function* () {
          var gameClient1Ret = yield (_crd && createAndEnterRoom === void 0 ? (_reportPossibleCrUseOfcreateAndEnterRoom({
            error: Error()
          }), createAndEnterRoom) : createAndEnterRoom)(testData.playerToken1, testData.playerId1, 'zum1', {
          ...
          yield testData.gameClient2.dismissRoom();
          gameClient3Ret = yield (_crd && createAndEnterRoom === void 0 ? (_reportPossibleCrUseOfcreateAndEnterRoom({
            error: Error()
          }), createAndEnterRoom) : createAndEnterRoom)(testData.playerToken3, testData.playerId3, 'zum3', {
            roomType: 'MeetingRoom',
            maxPlayers: 10
        ...
        test('获取或创建房间_同类型同时存在个数的限制', /*#__PURE__*/_asyncToGenerator(function* () {
        ...
        test('验证创建但不提取是否也算数量', /*#__PURE__*/_asyncToGenerator(function* () {
          var createRet1 = yield (_crd && hallClient === void 0 ? (_reportPossibleCrUseOfhallClient({
            error: Error()
          ...
          var createRet2 = yield (_crd && hallClient === void 0 ? (_reportPossibleCrUseOfhallClient({
            error: Error()
          ...
          var dismissRet = yield (_crd && appDismissRoom === void 0 ? (_reportPossibleCrUseOfappDismissRoom({
            error: Error()
          }), appDismissRoom) : appDismissRoom)(createRet1.data.roomId);
          (_crd && assert === void 0 ? (_reportPossibleCrUseOfassert({
            error: Error()
          }), assert) : assert).ok(dismissRet.succ, dismissRet.err);
          createRet2 = yield (_crd && hallClient === void 0 ? (_reportPossibleCrUseOfhallClient({
            error: Error()
          }), hallClient) : hallClient).createRoom(testData.playerToken2, {
            roomType: 'Plaza',
            roomName: 'zum2',
