System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  function buildMatchGroupKey(params) {
    ...
    //固定的参数
    var key = ((_params$matchType = params.matchType) != null ? _params$matchType : '') + "_" + params.matcherKey + "_" + params.maxPlayers; //开始队伍的部分
    ...
    if (params.teamParams) {
      if (params.teamParams.fixedTeamInfoList) {
        ...
        for (var i = 0; i < params.teamParams.fixedTeamCount; i++) {
          key += sp;
          sp = '|';
  ...
  function initMatchRequest(matchParams, limit) {
    if (limit === void 0) {
      limit = true;
    }
  ...
  function buildRoomJoinUsMatchRequest(roomMatchReq, roomId, teamsPlayerIds) {
    var attr = Object.assign({}, roomMatchReq.matcherParams);
    var teamParams = roomMatchReq.teamParams ? Object.assign({}, roomMatchReq.teamParams) : undefined;
    var reqParams = {
    ...
    var req = initMatchRequest(reqParams, false);
    return req;
  }
