  ...
  return {
    ...
    execute: function () {
      ...
      _export("FrameSyncGame", FrameSyncGame = class FrameSyncGame {
         ...
         */
        constructor(roomInfo, gameWsServer, gameConnMgr, getRoomAllPlayerConns, syncFrameRate = 30, randomRequirePlayerSyncStateInvMs) {
          this._inSync = false;
        ...
        startGame() {
          ...
          for (let playerInfo of this.roomInfo.playerList) {
            this.frameSyncExecutor.addPlayerInpFrame(playerInfo.playerId, (_crd && EPlayerInputFrameType === void 0 ? (_reportPossibleCrUseOfEPlayerInputFrameType({
              error: Error()
