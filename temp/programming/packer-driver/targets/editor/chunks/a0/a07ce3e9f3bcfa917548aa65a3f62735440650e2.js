  ...
  return {
    ...
    execute: function () {
      ...
      _export("MatchRequestTerminal", MatchRequestTerminal = class MatchRequestTerminal {
        ...
        async requestMatch(appId, matchParams, callback, limit = true) {
          ...
          if (this.useStateServer) {
            ...
            if (callback) {
              ...
              this.matchReqsResultCallback.set(req.matchReqId, result => {
                this.matchReqsResultCallback.delete(req.matchReqId); // 结果回来了就
        ...
        async queryMatch(appId, matchReqId) {
          if (this.useStateServer) {
        ...
        async cancelMatch(appId, matchReqId, currPlayerId) {
