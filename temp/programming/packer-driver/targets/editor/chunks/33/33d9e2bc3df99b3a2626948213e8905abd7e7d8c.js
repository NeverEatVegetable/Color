System.register([], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      _export("default", {
        name: 'tsgf-sdk-miniapp',
        version: '1.4.1',
        description: 'ts-gameframework(TSGF) client sdk for use in miniapp. TSGF is An open source platform that supports frame synchronization online. Select the corresponding SDK, such as tsgf-sdk-browser or tsgf-sdk-miniapp, based on your platform.',
        main: 'index.js',
        exports: {
          require: './index.js',
          'import': './index.mjs'
...
//# sourceMappingURL=33d9e2bc3df99b3a2626948213e8905abd7e7d8c.js.map