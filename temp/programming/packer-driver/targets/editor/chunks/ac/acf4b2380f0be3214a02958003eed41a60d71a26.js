  ...
  return {
    ...
    execute: function () {
      ...
      _export("RoomEvents", RoomEvents = class RoomEvents {
        ...
        async dispose() {
          this._eventEmitter.removeAllListeners(); //@ts-ignore
      ...
      _export("Room", Room = class Room {
        ...
        async dispose() {
          var _this$__gameClient;

          await ((_this$__gameClient = this.__gameClient) == null ? void 0 : _this$__gameClient.disconnect());
          this.__gameClient = undefined;
          await this.events.dispose(); //@ts-ignore
        ...
        */
        get currRoomInfo() {
          var _this$__gameClient$cu, _this$__gameClient2;

          return (_this$__gameClient$cu = (_this$__gameClient2 = this.__gameClient) == null ? void 0 : _this$__gameClient2.currRoomInfo) != null ? _this$__gameClient$cu : null;
        }
        /**
        ...
        */
        ...
        get myPlayerInfo() {
          var _this$__gameClient$cu2, _this$__gameClient3;

          return (_this$__gameClient$cu2 = (_this$__gameClient3 = this.__gameClient) == null ? void 0 : _this$__gameClient3.currPlayerInfo) != null ? _this$__gameClient$cu2 : null;
        }
        /**将事件注册到gameClient中*/
        ...
        */
        ...
        async __createGameClient(gameServerUrl, playerPara) {
          ...
          this.__gameClient = new (_crd && GameClient === void 0 ? (_reportPossibleCrUseOfGameClient({
            error: Error()
          }), GameClient) : GameClient)(gameServerUrl, this._game.__myPlayerToken, undefined, this._roomWaitReconnectTime);
        ...
        async recoverPlayerRoom(updateShowName) {
          let ret = await this._game.__hallClient.recoverPlayerRoom(this._game.__myPlayerId, this._game.__myPlayerToken, updateShowName); //这一步失败，一般是认证没通过
          ...
          this.__gameClient = new (_crd && GameClient === void 0 ? (_reportPossibleCrUseOfGameClient({
            error: Error()
          }), GameClient) : GameClient)(roomOnlineInfo.gameServerUrl, this._game.__myPlayerToken, undefined, this._roomWaitReconnectTime);
          ...
          this._setGameClientHandler(); //成功


          return (_crd && Result === void 0 ? (_reportPossibleCrUseOfResult({
            error: Error()
          }), Result) : Result).buildSucc(this.__gameClient.currRoomInfo);
        }
        /**
         * 获取房间在线信息（不进入房间也可以获取）
         *
        ...
        async filterRooms(filter, skip, limit) {
          let ret = await this._game.__hallClient.filterRooms(this._game.__myPlayerToken, filter, skip, limit);
          if (!ret.succ) return (_crd && Result === void 0 ? (_reportPossibleCrUseOfResult({
            error: Error()
          }), Result) : Result).transition(ret);
          return (_crd && Result === void 0 ? (_reportPossibleCrUseOfResult({
        ...
        async createRoom(playerPara, roomPara, teamId) {
          ...
          let joinRet = await this.__gameClient.joinRoom({
        ...
        async leaveRoom() {
          if (!this.__gameClient) return (_crd && Result === void 0 ? (_reportPossibleCrUseOfResult({
            error: Error()
        ...
        requestPlayersMatch(matchParamsFromPlayer, matchResultCallback) {
          ...
          return {
            ...
            async cancel() {
              ...
              await ((_waitCancel = waitCancel) == null ? void 0 : _waitCancel.cancel());
            }
        ...
        _startWaitMatchResultFromPlayers(matchParamsFromPlayer, matchReqId) {
          ...
          let timeoutTS = Date.now() + ((_matchParamsFromPlaye = matchParamsFromPlayer.matchTimeoutSec) != null ? _matchParamsFromPlaye : 60) * 1000 + 2000;
          let isCancel = false;
          ...
          return {
            ...
            async cancel() {
              ...
              isCancel = true;
              await ((_currDelayCancel = currDelayCancel) == null ? void 0 : _currDelayCancel.cancel());
            }
