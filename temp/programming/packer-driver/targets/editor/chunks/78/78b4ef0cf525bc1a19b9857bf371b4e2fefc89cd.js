System.register(["__unresolved_0", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfreq(extras) {
    _reporterNs.report("req", "./jest.config.js", _context.meta, extras);
  }

  function _reportPossibleCrUseOfd(extras) {
    _reporterNs.report("d", "./jest.config.js", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      _crd = true; // I am the facade module who provides access to the CommonJS module './jest.config.js'~

      if (!(_crd && req === void 0 ? (_reportPossibleCrUseOfreq({
        error: Error()
      }), req) : req)) {
        loader.throwInvalidWrapper('./jest.config.js', _context.meta.url);
      }
...
//# sourceMappingURL=78b4ef0cf525bc1a19b9857bf371b4e2fefc89cd.js.map