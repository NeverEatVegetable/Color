System.register(["__unresolved_0", "cc", "chai", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      describe('固定队伍匹配计算验证', () => {
        let matcher = new (_crd && MatcherFixedTeams === void 0 ? (_reportPossibleCrUseOfMatcherFixedTeams({
          error: Error()
        ...
        function buildSinglePlayerMatchReq(playerIds, fixedTeamCount, teamMinPlayers, teamMaxPlayers) {
          ...
          let req = (_crd && initMatchRequest === void 0 ? (_reportPossibleCrUseOfinitMatchRequest({
            error: Error()
        ...
        test('1个队伍(1~1) 1人*1请求', async function () {
          ...
          //满足最低要求
          let allPlayersReqs = [buildSinglePlayerMatchReq(['1'], 1, 1, 1)];
        ...
        test('1个队伍(1~2) 1人*1请求', async function () {
          ...
          //满足最低要求
          let allPlayersReqs = [buildSinglePlayerMatchReq(['1'], 1, 1, 2)];
          let result = matcher.onPollMatcherReqs(allPlayersReqs);
          (_crd && assert === void 0 ? (_reportPossibleCrUseOfassert({
            error: Error()
          }), assert) : assert).ok(result.hasResult, '应该要有结果了!');
        ...
        test('1个队伍(1~2) 2人*1请求', async function () {
          ...
          //满足最低要求
          let allPlayersReqs = [buildSinglePlayerMatchReq(['1', '2'], 1, 1, 2)];
          let result = matcher.onPollMatcherReqs(allPlayersReqs);
          (_crd && assert === void 0 ? (_reportPossibleCrUseOfassert({
            error: Error()
          }), assert) : assert).ok(result.hasResult, '应该要有结果了!');
        ...
        test('1个队伍(1~2) 1人*2请求', async function () {
          ...
          //组合满
          let allPlayersReqs = [buildSinglePlayerMatchReq(['1'], 1, 1, 2), buildSinglePlayerMatchReq(['2'], 1, 1, 2)];
          let result = matcher.onPollMatcherReqs(allPlayersReqs);
          (_crd && assert === void 0 ? (_reportPossibleCrUseOfassert({
            error: Error()
          }), assert) : assert).ok(result.hasResult, '应该要有结果了!');
        ...
        test('1个队伍(1~2) 2人*2请求', async function () {
          ...
          //组合满
          let allPlayersReqs = [buildSinglePlayerMatchReq(['1', '1a'], 1, 1, 2), buildSinglePlayerMatchReq(['2', '2a'], 1, 1, 2)];
          let result = matcher.onPollMatcherReqs(allPlayersReqs);
          (_crd && assert === void 0 ? (_reportPossibleCrUseOfassert({
            error: Error()
          }), assert) : assert).ok(result.hasResult, '应该要有结果了!');
        ...
        test('1个队伍(1~2) 1人*3请求', async function () {
          ...
          //1个满,再1个最低要求
          let allPlayersReqs = [buildSinglePlayerMatchReq(['1'], 1, 1, 2), buildSinglePlayerMatchReq(['2'], 1, 1, 2), buildSinglePlayerMatchReq(['3'], 1, 1, 2)];
          let result = matcher.onPollMatcherReqs(allPlayersReqs);
          (_crd && assert === void 0 ? (_reportPossibleCrUseOfassert({
            error: Error()
          }), assert) : assert).ok(result.hasResult, '应该要有结果了!');
        ...
        test('1个队伍(1~2) 2人*3请求', async function () {
          ...
          let allPlayersReqs = [buildSinglePlayerMatchReq(['1', '1a'], 1, 1, 2), buildSinglePlayerMatchReq(['2', '2a'], 1, 1, 2), buildSinglePlayerMatchReq(['3', '3a'], 1, 1, 2)];
          let result = matcher.onPollMatcherReqs(allPlayersReqs);
          (_crd && assert === void 0 ? (_reportPossibleCrUseOfassert({
            error: Error()
          }), assert) : assert).ok(result.hasResult, '应该要有结果了!');
        ...
        test('1个队伍(1~3) 1人*5请求', async function () {
          ...
          //1个满,再1个最低要求并推满
          let allPlayersReqs = [buildSinglePlayerMatchReq(['1'], 1, 1, 3), buildSinglePlayerMatchReq(['2'], 1, 1, 3), buildSinglePlayerMatchReq(['3'], 1, 1, 3), buildSinglePlayerMatchReq(['4'], 1, 1, 3), buildSinglePlayerMatchReq(['5'], 1, 1, 3)];
          let result = matcher.onPollMatcherReqs(allPlayersReqs);
          (_crd && assert === void 0 ? (_reportPossibleCrUseOfassert({
            error: Error()
          }), assert) : assert).ok(result.hasResult, '应该要有结果了!');
        ...
        test('1个队伍(1~3) 2人*5请求', async function () {
          ...
          //1个满,再1个最低要求并推满
          let allPlayersReqs = [buildSinglePlayerMatchReq(['1', '1a'], 1, 1, 3), buildSinglePlayerMatchReq(['2', '2a'], 1, 1, 3), buildSinglePlayerMatchReq(['3', '3a'], 1, 1, 3), buildSinglePlayerMatchReq(['4', '4a'], 1, 1, 3), buildSinglePlayerMatchReq(['5', '5a'], 1, 1, 3)];
          let result = matcher.onPollMatcherReqs(allPlayersReqs);
          (_crd && assert === void 0 ? (_reportPossibleCrUseOfassert({
            error: Error()
          }), assert) : assert).ok(result.hasResult, '应该要有结果了!');
        ...
        test('2个队伍各(1~1) 1人*2请求', async function () {
          ...
          //2个队伍(1~1)组合满
          let allPlayersReqs = [buildSinglePlayerMatchReq(['1'], 2, 1, 1), buildSinglePlayerMatchReq(['2'], 2, 1, 1)];
          let result = matcher.onPollMatcherReqs(allPlayersReqs);
          (_crd && assert === void 0 ? (_reportPossibleCrUseOfassert({
            error: Error()
          }), assert) : assert).ok(result.hasResult, '应该要有结果了!');
        ...
        test('2个队伍各(1~1) 2人*2请求', async function () {
          //2个队伍(1~1)组合满
          let allPlayersReqs = [buildSinglePlayerMatchReq(['1', '1a'], 2, 1, 1), buildSinglePlayerMatchReq(['2', '2a'], 2, 1, 1)];
          let result = matcher.onPollMatcherReqs(allPlayersReqs);
          (_crd && assert === void 0 ? (_reportPossibleCrUseOfassert({
            error: Error()
        ...
        test('2个队伍各(1~2) 1人*2请求', async function () {
          ...
          //2个队伍(1~2)满足最低要求
          let allPlayersReqs = [buildSinglePlayerMatchReq(['1'], 2, 1, 2), buildSinglePlayerMatchReq(['2'], 2, 1, 2)];
          let result = matcher.onPollMatcherReqs(allPlayersReqs);
          (_crd && assert === void 0 ? (_reportPossibleCrUseOfassert({
            error: Error()
          }), assert) : assert).ok(result.hasResult, '应该要有结果了!');
        ...
        test('2个队伍各(1~2) 2人*2请求', async function () {
          ...
          //2个队伍(1~2)满足最低要求
          let allPlayersReqs = [buildSinglePlayerMatchReq(['1', '1a'], 2, 1, 2), buildSinglePlayerMatchReq(['2', '2a'], 2, 1, 2)];
          let result = matcher.onPollMatcherReqs(allPlayersReqs);
          (_crd && assert === void 0 ? (_reportPossibleCrUseOfassert({
            error: Error()
          }), assert) : assert).ok(result.hasResult, '应该要有结果了!');
        ...
        test('2个队伍各(1~3) 1人*2请求', async function () {
          ...
          //2个队伍(1~3)满足最低要求
          let allPlayersReqs = [buildSinglePlayerMatchReq(['1'], 2, 1, 3), buildSinglePlayerMatchReq(['2'], 2, 1, 3)];
          let result = matcher.onPollMatcherReqs(allPlayersReqs);
          (_crd && assert === void 0 ? (_reportPossibleCrUseOfassert({
            error: Error()
          }), assert) : assert).ok(result.hasResult, '应该要有结果了!');
        ...
        test('2个队伍各(1~3) 2人*2请求', async function () {
          ...
          let allPlayersReqs = [buildSinglePlayerMatchReq(['1', '1a'], 2, 1, 3), buildSinglePlayerMatchReq(['2', '2a'], 2, 1, 3)];
          let result = matcher.onPollMatcherReqs(allPlayersReqs);
          (_crd && assert === void 0 ? (_reportPossibleCrUseOfassert({
            error: Error()
          }), assert) : assert).ok(result.hasResult, '应该要有结果了!');
        ...
        test('2个队伍各(1~2) 1人*4请求', async function () {
          ...
          //2个队伍(1~2)组合满
          let allPlayersReqs = [buildSinglePlayerMatchReq(['1'], 2, 1, 2), buildSinglePlayerMatchReq(['2'], 2, 1, 2), buildSinglePlayerMatchReq(['3'], 2, 1, 2), buildSinglePlayerMatchReq(['4'], 2, 1, 2)];
          let result = matcher.onPollMatcherReqs(allPlayersReqs);
          (_crd && assert === void 0 ? (_reportPossibleCrUseOfassert({
            error: Error()
          }), assert) : assert).ok(result.hasResult, '应该要有结果了!');
        ...
        test('2个队伍各(1~2) 2人*4请求', async function () {
          ...
          let allPlayersReqs = [buildSinglePlayerMatchReq(['1', '1a'], 2, 1, 2), buildSinglePlayerMatchReq(['2', '2a'], 2, 1, 2), buildSinglePlayerMatchReq(['3', '3a'], 2, 1, 2), buildSinglePlayerMatchReq(['4', '4a'], 2, 1, 2)];
          let result = matcher.onPollMatcherReqs(allPlayersReqs);
          (_crd && assert === void 0 ? (_reportPossibleCrUseOfassert({
            error: Error()
          }), assert) : assert).ok(result.hasResult, '应该要有结果了!');
        ...
        test('2个队伍各(1~2) 2+2+2+1人请求', async function () {
          ...
          let allPlayersReqs = [buildSinglePlayerMatchReq(['1', '1a'], 2, 1, 2), buildSinglePlayerMatchReq(['2', '2a'], 2, 1, 2), buildSinglePlayerMatchReq(['3', '3a'], 2, 1, 2), buildSinglePlayerMatchReq(['4'], 2, 1, 2)];
          let result = matcher.onPollMatcherReqs(allPlayersReqs);
          (_crd && assert === void 0 ? (_reportPossibleCrUseOfassert({
            error: Error()
          }), assert) : assert).ok(result.hasResult, '应该要有结果了!');
        ...
        test('2个队伍各(1~2) 2+2+1+1人请求', async function () {
          ...
          let allPlayersReqs = [buildSinglePlayerMatchReq(['1', '1a'], 2, 1, 2), buildSinglePlayerMatchReq(['2', '2a'], 2, 1, 2), buildSinglePlayerMatchReq(['3'], 2, 1, 2), buildSinglePlayerMatchReq(['4'], 2, 1, 2)];
          let result = matcher.onPollMatcherReqs(allPlayersReqs);
          (_crd && assert === void 0 ? (_reportPossibleCrUseOfassert({
            error: Error()
          }), assert) : assert).ok(result.hasResult, '应该要有结果了!');
        ...
        test('3个队伍各(1~3) 1人*3请求', async function () {
          ...
          //3个队伍(1~3)满足最低要求
          let allPlayersReqs = [buildSinglePlayerMatchReq(['1'], 3, 1, 3), buildSinglePlayerMatchReq(['2'], 3, 1, 3), buildSinglePlayerMatchReq(['3'], 3, 1, 3)];
          let result = matcher.onPollMatcherReqs(allPlayersReqs);
          (_crd && assert === void 0 ? (_reportPossibleCrUseOfassert({
            error: Error()
          }), assert) : assert).ok(result.hasResult, '应该要有结果了!');
        ...
        test('3个队伍各(1~3) 2人*3请求', async function () {
          ...
          let allPlayersReqs = [buildSinglePlayerMatchReq(['1', '1a'], 3, 1, 3), buildSinglePlayerMatchReq(['2', '2a'], 3, 1, 3), buildSinglePlayerMatchReq(['3', '3a'], 3, 1, 3)];
          let result = matcher.onPollMatcherReqs(allPlayersReqs);
          (_crd && assert === void 0 ? (_reportPossibleCrUseOfassert({
            error: Error()
          }), assert) : assert).ok(result.hasResult, '应该要有结果了!');
        ...
        test('3个队伍各(1~3) 3人*3请求', async function () {
          ...
          let allPlayersReqs = [buildSinglePlayerMatchReq(['1', '1a', '1b'], 3, 1, 3), buildSinglePlayerMatchReq(['2', '2a', '2b'], 3, 1, 3), buildSinglePlayerMatchReq(['3', '3a', '3b'], 3, 1, 3)];
          let result = matcher.onPollMatcherReqs(allPlayersReqs);
          (_crd && assert === void 0 ? (_reportPossibleCrUseOfassert({
            error: Error()
          }), assert) : assert).ok(result.hasResult, '应该要有结果了!');
        ...
        test('3个队伍各(1~3) 1+2+3人请求', async function () {
          ...
          let allPlayersReqs = [buildSinglePlayerMatchReq(['1'], 3, 1, 3), buildSinglePlayerMatchReq(['2', '2a'], 3, 1, 3), buildSinglePlayerMatchReq(['3', '3a', '3b'], 3, 1, 3)];
          let result = matcher.onPollMatcherReqs(allPlayersReqs);
          (_crd && assert === void 0 ? (_reportPossibleCrUseOfassert({
            error: Error()
          }), assert) : assert).ok(result.hasResult, '应该要有结果了!');
        ...
        test('3个队伍各(1~3) 1+2+3+1+2人请求', async function () {
          ...
          let allPlayersReqs = [buildSinglePlayerMatchReq(['1'], 3, 1, 3), buildSinglePlayerMatchReq(['2', '2a'], 3, 1, 3), buildSinglePlayerMatchReq(['3', '3a', '3b'], 3, 1, 3), buildSinglePlayerMatchReq(['4'], 3, 1, 3), buildSinglePlayerMatchReq(['5', '5a'], 3, 1, 3)];
          let result = matcher.onPollMatcherReqs(allPlayersReqs);
          (_crd && assert === void 0 ? (_reportPossibleCrUseOfassert({
            error: Error()
          }), assert) : assert).ok(result.hasResult, '应该要有结果了!');
        ...
        test('3个队伍各(1~3) 1人*6请求', async function () {
          ...
          //3个队伍(1~3)满足最低要求再补充
          let allPlayersReqs = [buildSinglePlayerMatchReq(['1'], 3, 1, 3), buildSinglePlayerMatchReq(['2'], 3, 1, 3), buildSinglePlayerMatchReq(['3'], 3, 1, 3), buildSinglePlayerMatchReq(['4'], 3, 1, 3), buildSinglePlayerMatchReq(['5'], 3, 1, 3), buildSinglePlayerMatchReq(['6'], 3, 1, 3)];
          let result = matcher.onPollMatcherReqs(allPlayersReqs);
          (_crd && assert === void 0 ? (_reportPossibleCrUseOfassert({
            error: Error()
          }), assert) : assert).ok(result.hasResult, '应该要有结果了!');
        ...
        test('3个队伍各(2~3) 1人*6请求', async function () {
          ...
          let allPlayersReqs = [buildSinglePlayerMatchReq(['1'], 3, 2, 3), buildSinglePlayerMatchReq(['2'], 3, 2, 3), buildSinglePlayerMatchReq(['3'], 3, 2, 3), buildSinglePlayerMatchReq(['4'], 3, 2, 3), buildSinglePlayerMatchReq(['5'], 3, 2, 3), buildSinglePlayerMatchReq(['6'], 3, 2, 3)];
          let result = matcher.onPollMatcherReqs(allPlayersReqs);
          (_crd && assert === void 0 ? (_reportPossibleCrUseOfassert({
            error: Error()
          }), assert) : assert).ok(result.hasResult, '应该要有结果了!');
        ...
        test('房间招人:2个队伍各(1~2) 已有1*2人, 匹配1人*1请求', async function () {
          ...
          let allPlayersReqs = [buildRoomJoinUsMatchReq('1', 2, 1, 2, [{
            teamId: '1',
            playerIds: ['1']
          }, {
            teamId: '2',
        ...
        test('房间招人:2个队伍各(1~3) 已有1+1人, 匹配1+2人请求', async function () {
          ...
          let allPlayersReqs = [buildRoomJoinUsMatchReq('1', 2, 1, 3, [{
            teamId: '1',
            playerIds: ['1']
          }, {
            teamId: '2',
