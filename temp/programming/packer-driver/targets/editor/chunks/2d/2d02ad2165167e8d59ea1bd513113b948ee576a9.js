System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "b7b60qBkI5ADarPFBOcsM7l", "AClient", undefined);
      ...
      _export("AHttpClient", AHttpClient = class AHttpClient {
        constructor(proto, options) {
          ...
          this.client = void 0;
          const env = (_ref = (_crd && getGlobalSDKProvider === void 0 ? (_reportPossibleCrUseOfgetGlobalSDKProvider({
            error: Error()
      ...
      _export("AWsClient", AWsClient = class AWsClient {
        constructor(proto, options) {
          ...
          this.client = void 0;
          const env = (_ref2 = (_crd && getGlobalSDKProvider === void 0 ? (_reportPossibleCrUseOfgetGlobalSDKProvider({
            error: Error()
...
//# sourceMappingURL=2d02ad2165167e8d59ea1bd513113b948ee576a9.js.map