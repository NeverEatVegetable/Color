    ...
    execute: function () {
      ...
      describe('单人匹配计算验证', () => {
        ...
        test('Single_1人的房间', async function () {
          ...
          let allPlayersReqs = [buildSinglePlayerMatchReq('4a', 1, 9)];
        ...
        test('Single_单玩家匹配再房间招人匹配', async function () {
          ...
          let allPlayersReqs = [buildSinglePlayerMatchReq('4a', 2, 4), buildSinglePlayerMatchReq('4b', 2, 4), buildSinglePlayerMatchReq('3a', 2, 3), buildSinglePlayerMatchReq('3a', 2, 3), buildSinglePlayerMatchReq('2a', 2, 2), buildSinglePlayerMatchReq('2b', 2, 2)];
          let result = matcher.onPollMatcherReqs(allPlayersReqs);
          (_crd && assert === void 0 ? (_reportPossibleCrUseOfassert({
            error: Error()
          }), assert) : assert).ok(result.hasResult, '应该要有结果了!');
          ...
          let roomJoinUsInfo = roomJoinUsMatchReq4.matchFromInfo;
          matchPlayerIds = [];
